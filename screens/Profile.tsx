...
export default function ProfileScreen({
  ...
  const challengesToRender = challengeData.map((challenge) => (
    <Challenge key={challenge.name} name={challenge.name} />
  ));
        ...
        <Container style={styles.container}>
          ...
          <CenteredRowContainer style={styles.mainContainer}>
            ...
            <ColContainer style={styles.padding}>
              ...
              <RowContainer>
                <ProfileBody
                  style={[styles.yellowText, styles.profileInfoText]}
                >
                  {profileData.numberOfFriends}{' '}
                </ProfileBody>
                <Body style={[styles.yellowText, styles.profileInfoText]}>
                  Friends{' '}
                </Body>
              </RowContainer>
              <RowContainer>
                <ProfileBody
                  style={[styles.yellowText, styles.profileInfoText]}
                >
                  {profileData.numberOfChallenges}{' '}
                </ProfileBody>
                <Body style={[styles.yellowText, styles.profileInfoText]}>
                  Challenges{' '}
                </Body>
              ...
              >
                <ProfileBody style={styles.linkText}>Edit Profile</ProfileBody>
              </TouchableOpacity>
            </ColContainer>
          </CenteredRowContainer>
          <Heading style={[styles.smallText, styles.padding]}>
            {profileData.bio}
          </Heading>
                ...
                <View style={styles.tabView}>
                  <View style={[styles.textContainer, styles.shadowContainer]}>
                    <Heading style={[styles.infoText, styles.yellowText]}>
                      Challenges are groups you can make/join with your friends
                      where you compete and/or work together to complete habits
                      consistently!
                    </Heading>
                  </View>
                  {challengesToRender}
